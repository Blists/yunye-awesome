...
.ui-input {
    .ui-input-panel {
        ...
        .ui-input-emoji {
            width: 40px;
            background: url(../assets/键盘表情-默认.png) no-repeat center;
            background-size: auto 23px;
            &:active {
                background-image: url(../assets/键盘表情-点击.png);
            }
        }
        .ui-input-input {
            flex: 1;
        ...
        .ui-input-video {
            width: 40px;
            background: url(../assets/键盘语音-默认.png) no-repeat center;
            background-size: auto 23px;
            &:active {
                background-image: url(../assets/键盘语音-选中.png);
            }
        }
        .ui-input-photo {
            width: 40px;
            height: @input-height;
            background: url(../assets/键盘图片-默认.png) no-repeat center;
            background-size: auto 22px;
            overflow: hidden;
            &:active {
                background-image: url(../assets/键盘图片-选中.png);
            }
            input {
        ...
        .ui-input-add {
            width: 40px;
            background: url(../assets/键盘添加-默认.png) no-repeat center;
            background-size: auto 28px;
            &:active {
                background-image: url(../assets/键盘添加-点击.png);
            }
            &.active {
                background-image: url(../assets/键盘减少-点击.png);
                &:active {
                    background-image: url(../assets/键盘减少-点击.png);
                }
            }
    ...
    .ui-input-container {
        ...
        .ui-input-container-video {
            ...
            .button {
                ...
                width: 105px;
                height: 105px;
                background: url(../assets/按住说话-默认.png) no-repeat center;
                background-size: 105px 105px;
                -webkit-touch-callout: none;
                -webkit-user-select: none;
                &.active {
                    background-image: url(../assets/按住说话-点击.png);
                }
            }
            div {
                padding-top: 20px;
    ...
    .ui-input-recording {
        ...
        &:after {
            ...
            width: 100%;
            height: 100%;
            background: url(../assets/record.gif) no-repeat center;
